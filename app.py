...
def calculate_attendance(absences):
    if absences < 0 or absences > 4:
        return None
    return max(0, 100 - (absences * 10))  # Adjust the attendance score logic as needed
...
# Input fields
absences = st.number_input("Number of Consecutive Absences:", min_value=0, max_value=100, value=0)
